        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false, collation: "tr_icu_det"),
                    Description = table.Column<string>(type: "text", nullable: true),
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    Rating = table.Column<float>(type: "real", nullable: false),
                    ExtraAmount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullAddress = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    City = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    State = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    Neighbourhood = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Cart_Owner", "(\"UserId\" IS NOT NULL AND \"AnonId\" IS NULL) OR (\"UserId\" IS NULL AND \"AnonId\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonId = table.Column<string>(type: "text", nullable: true),
                    BuyerName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    BuyerEmail = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    BuyerPhone = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    ShippingAddressText = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    ...
                    ShippingNeighbourhood = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteListItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteListItems_FavoriteLists_FavoriteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_AnonId",
                table: "Carts",
                column: "AnonId",
                unique: true,
                filter: "\"AnonId\" IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteListItems_FavoriteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedCards_UserId_CardToken",
                table: "SavedCards",
                columns: new[] { "UserId", "CardToken" },
                unique: true);
